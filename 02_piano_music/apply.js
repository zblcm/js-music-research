...
AudioAnalysis.instrument_data = function(period) {
	...
	this.analyze = function(maximum) {
		...
		/*
		AudioAnalysis.play(an, bn, 329.628, 2, 4);
		AudioAnalysis.play(an, bn, 391.995, 2, 4);
		// C
		setTimeout(function() {
			AudioAnalysis.play(an, bn, 261.626, 2, 4);
			AudioAnalysis.play(an, bn, 329.628, 2, 4);
			AudioAnalysis.play(an, bn, 391.995, 2, 4);
		}, 2000);
		...
		// B
		setTimeout(function() {
			AudioAnalysis.play(an, bn, 246.942, 2, 4);
			AudioAnalysis.play(an, bn, 329.628, 2, 4);
			AudioAnalysis.play(an, bn, 391.995, 2, 4);
		}, 4000);
		
		// Custom between A# and B
		setTimeout(function() {
			AudioAnalysis.play(an, bn, 235.246, 2, 4);
			AudioAnalysis.play(an, bn, 329.628, 2, 4);
			AudioAnalysis.play(an, bn, 391.995, 2, 4);
		}, 6000);
		...
		// A#
		setTimeout(function() {
			AudioAnalysis.play(an, bn, 233.082, 2, 4);
			AudioAnalysis.play(an, bn, 329.628, 2, 4);
			AudioAnalysis.play(an, bn, 391.995, 2, 4);
		}, 8000);
		...
		// A
		setTimeout(function() {
			AudioAnalysis.play(an, bn, 220.082, 2, 4);
			AudioAnalysis.play(an, bn, 329.628, 2, 4);
			AudioAnalysis.play(an, bn, 391.995, 2, 4);
		}, 10000);
		*/
		...
		setTimeout(function() {
			AudioAnalysis.play(an, bn, 261.626, 2, 4);
			AudioAnalysis.play(an, bn, 329.628, 2, 4);
			AudioAnalysis.play(an, bn, 349.228, 2, 4);
		}, 4000);
